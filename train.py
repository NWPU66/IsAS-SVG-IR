...
from scene.direct_light_sg import DirectLightSG
...
def training(dataset: ModelParams, opt: OptimizationParams, pipe: PipelineParams, is_pbr=False):
    ...
    if is_pbr:
        ...
        gaussians.update_radiace(pipe.sample_num)

        gaussians.add_radiance_to_optimizer()
        ...
        # direct_env_light = DirectLightSG(numLgtSGs=32, H=dataset.env_resolution)
    ...
    for iteration in progress_bar:
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter and gaussians.get_xyz.shape[0] < opt.max_points:
            ...
            # if iteration == 35000 and is_pbr:
            #     direct_env_light.optimizer.param_groups[0]['lr'] = opt.env_lr
            # Optimizer step
            gaussians.step()
...
if __name__ == "__main__":
    ...
    is_pbr = args.type in ['render_relight']
